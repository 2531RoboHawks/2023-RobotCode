...
public class ManualGripper extends CommandBase {
  ...
  public ManualGripper(ArmSubsystem m_armSubsystem, Joystick gripperController, int gripperAxis, int shoulderAxis, int elbowAxis, int wristAxis) {
    ...
    elbowPIDController.setSetpoint(m_armSubsystem.getElbowAngle()); //Sets the setpoint of the elbow PID Controller to the Midium position
    ...
    wristPIDController.setSetpoint(m_armSubsystem.getWristAngle()); //Sets the setpoint of the wrist PID Controller to the Midium position
  }
